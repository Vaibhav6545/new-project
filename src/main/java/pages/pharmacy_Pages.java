...
//	PLease write all the required locators here
	...
	public boolean loginToHealthAppByGivenValidCredetial(Map<String, String> expectedData) throws Exception {
		...
		try {
		usernameTextbox.sendKeys(expectedData.get("admin"));
		passwordTextbox.sendKeys(expectedData.get("pass123"));
		...
		String expectedTitle = expectedData.get("DanpheHealth");
		
		String expectedURL   = expectedData.get(" https://healthapp.yaksha.com/");
		
		
		if(actualTitle.equals(expectedTitle) && actualURL.equals(expectedURL) ) {
			
			System.out.println("Login Successful - Titl and URL verified.");
			
		} else {
			
			System.out.println("Validation failed");
			System.out.println("ExpectedTitle: "+  expectedTitle +  "| Actual Title: " + actualTitle );
			System.out.println("ExpectedURL: "+  expectedURL +  "| Actual URL: " + actualURL );
			return false;
		}
